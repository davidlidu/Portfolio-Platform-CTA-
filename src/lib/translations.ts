...
const translations = {
  es: {
    ...
    "dash.col.opens": "Aperturas",
    "dash.col.leads": "Leads",
    "dash.col.status": "Estado",
    "dash.col.actions": "Acciones",
    "dash.sum.opens": "Aperturas totales",
    "dash.sum.leads": "Leads totales",
    "dash.sum.published": "Publicados",
    ...
    // Tab INSIGHTS (analítica + tarjetas NFC)
    "form.tab.insights": "Insights",
    "insights.refresh": "Actualizar",
    "insights.loading": "Cargando analítica...",
    "insights.error": "No se pudo cargar la analítica.",
    "insights.opens": "Aperturas",
    "insights.nfc_opens": "Por NFC",
    "insights.unique": "Únicos",
    "insights.leads": "Leads",
    "insights.conversion": "Conversión",
    "insights.by_day": "Aperturas (últimos 30 días)",
    "insights.by_device": "Dispositivos",
    "insights.no_device": "Sin datos aún",
    "insights.cards_title": "Tarjetas NFC",
    "insights.cards_hint": "Graba esta URL en cada tarjeta. Cada una mide sus propias aperturas.",
    "insights.card_label_ph": "Etiqueta (ej. Tarjeta oficina)",
    "insights.card_create": "Crear tarjeta",
    "insights.card_empty": "Aún no hay tarjetas. Crea la primera arriba.",
    "insights.card_copy": "Copiar URL",
    "insights.card_copied": "¡Copiado!",
    "insights.card_active": "Activa",
    "insights.card_inactive": "Inactiva",
    "insights.card_delete": "Eliminar",
    "insights.card_delete_confirm": "¿Eliminar esta tarjeta? Sus aperturas quedan sin atribución.",
    "insights.col_card": "Tarjeta",
    ...
    "basic.leadgate": "Formulario de acceso",
  ...
  en: {
    ...
    "dash.col.opens": "Opens",
    "dash.col.leads": "Leads",
    "dash.col.status": "Status",
    "dash.col.actions": "Actions",
    "dash.sum.opens": "Total opens",
    "dash.sum.leads": "Total leads",
    "dash.sum.published": "Published",
    ...
    // Tab INSIGHTS (analytics + NFC cards)
    "form.tab.insights": "Insights",
    "insights.refresh": "Refresh",
    "insights.loading": "Loading analytics...",
    "insights.error": "Couldn't load analytics.",
    "insights.opens": "Opens",
    "insights.nfc_opens": "Via NFC",
    "insights.unique": "Unique",
    "insights.leads": "Leads",
    "insights.conversion": "Conversion",
    "insights.by_day": "Opens (last 30 days)",
    "insights.by_device": "Devices",
    "insights.no_device": "No data yet",
    "insights.cards_title": "NFC cards",
    "insights.cards_hint": "Write this URL to each card. Each one tracks its own opens.",
    "insights.card_label_ph": "Label (e.g. Office card)",
    "insights.card_create": "Create card",
    "insights.card_empty": "No cards yet. Create the first one above.",
    "insights.card_copy": "Copy URL",
    "insights.card_copied": "Copied!",
    "insights.card_active": "Active",
    "insights.card_inactive": "Inactive",
    "insights.card_delete": "Delete",
    "insights.card_delete_confirm": "Delete this card? Its opens will lose attribution.",
